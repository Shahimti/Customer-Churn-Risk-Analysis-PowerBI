...
Decomposition Tree:
 Analyzes churn customers and identifies the strongest contributing factors (Contract Type, Payment Group, Internet Type, Monthly Charges, etc.).
...
10. Findings From the Project
Below are the types of insights observed from the dashboard. These will vary depending on the filters applied. Fill in the numeric values after reviewing your dashboard.
